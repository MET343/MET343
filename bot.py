...
BOT_TOKEN = "7967576252:AAGwbAnJ-KKv-Fjz6Ia5y-jNhZ2JVhJfsVc"
...
if __name__ == '__main__':
    if not BOT_TOKEN or BOT_TOKEN == "7967576252:AAGwbAnJ-KKv-Fjz6Ia5y-jNhZ2JVhJfsVc":
        print("❌ BOT_TOKEN مفقود أو لم يتم إدخاله.")
        exit(1)
